...
RESEARCH = [
    {"researchCategory": "종목분석", "itemCode": "000660", "itemName": "SK하이닉스", "researchId": 96025, "title": "HBM 고객 다변화 본격화",
     "brokerName": "미래에셋증권", "writeDate": "2026-09-07", "endUrl": "https://m.stock.naver.com/research/company/96025"},
    {"researchCategory": "종목분석", "itemCode": "000660", "itemName": "SK하이닉스", "researchId": 95900, "title": "3분기도 좋다",
     "brokerName": "신한투자증권", "writeDate": "2026-08-26"},
]
...
def test_parse_reports():
    ...
    assert rs[0].url == "https://m.stock.naver.com/research/company/96025" and rs[0].code == "000660"
    assert rs[1].url.endswith("/research/company/95900")
